...
L.cartoDB('https://m-logie.cartodb.com/api/v2/sql?q=SELECT * FROM communityassets_ml &api_key=0fdb4395e627c82241b747dac67b3f441fc27991', {
		 pointToLayer: function (feature, latlng) {
          return L.marker(latlng);},
		onEachFeature: function (feature, layer) {
				layer.bindPopup('<b>'+ feature.properties.comm_asset + '</b><br>' + feature.properties.comm_name + '<br><br>'  + feature.properties.description);
